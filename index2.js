// https://observablehq.com/@kerryrodden/sequences-sunburst@493
    ...
    d3.csvParseRows(await FileAttachment("data.csv").text())
    )}
    ...
    export default function define(runtime, observer) {
      ...
      const fileAttachments = new Map([
        ["data.csv", {url: new URL("./data/PalabrasFrecxGrupoIngles.csv", import.meta.url), mimeType: "text/csv", toString}]
      ]);
      ...
      main.define("sunburst", ["Generators", "viewof sunburst"], (G, _) => G.input(_));
      main.define("csv", ["d3","FileAttachment"], _csv);
      main.define("data", ["buildHierarchy","csv"], _data);
      main.define("partition", ["d3","radius"], _partition);
      main.define("color", ["d3"], _color);
      main.define("width", _width);
      main.define("radius", ["width"], _radius);
      main.define("arc", ["d3","radius"], _arc);
      main.define("mousearc", ["d3","radius"], _mousearc);
      main.define("buildHierarchy", _buildHierarchy);
      main.define("breadcrumbWidth", _breadcrumbWidth);
      main.define("breadcrumbHeight", _breadcrumbHeight);
      main.define("breadcrumbPoints", ["breadcrumbWidth","breadcrumbHeight"], _breadcrumbPoints);
